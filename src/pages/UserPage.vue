  ...
  <div class="user-page">
    <div class="user-header">
      <div class="user-header-info">
        <h1 class="user-header-title">Привет, {{ authStore.userData?.username }} !</h1>
...
const avatarUrl = computed(() => `https://i.pravatar.cc/150?u=${authStore.userData?.id}`);
...
const handlePasswordChange = handlePasswordSubmit((values) => {
  const success = authStore.changePassword(values.currentPassword, values.newPassword);
